...
export const PROVIDER_CONFIGS: Partial<Record<SmsProviderType, ProviderConfig>> = {
  ...
  generic_rest: {
    label: "Generic REST",
    description: "Any HTTP REST SMS API",
    fields: [
      {
        key: "endpoint",
      ...
      },
      {
        ...
        sensitive: true,
        placeholder: "••••••••",
        helpText: "Token or key value for the selected auth type",
      },
      {
        key: "bodyTemplate",
        ...
        helpText: "Use {{phone}}, {{message}}, {{otp}} as placeholders",
      },
      {
        key: "successPath",
        ...
        sensitive: false,
        placeholder: "status",
        helpText: "Dot-notation path in response body to check for success",
      },
      {
        key: "successValue",
        ...
        sensitive: false,
        placeholder: "ok",
        helpText: "Value at successPath that indicates a successful send",
      },
    ],
  },
};
